...
@section('main_content')
    <div class="page-top">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2>Календарь мусульманских религиозных дат</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container" >
        <div class="row">
            <div class="col-12">
                <h3 class="text-center mt-5">Календарь мусульманских религиозных дат</h3>
           ...
           //     dayNamesShort: ["ВС","ПН","ВТ","СР","ЧТ","ПТ","СБ"],
                ...
                select: function(start, end, allDays) {
                    ...
                    $('#saveBtn').click(function() {
                        ...
                        $.ajax({
                            url:"{{ route('calendarmuslim.store') }}",
                            type:"POST",
                            dataType:'json',
                ...
                eventDrop: function(event) {
                    ...
                    $.ajax({
                        url:"{{ route('calendarmuslim.update', '') }}" +'/'+ id,
                        type:"PATCH",
                        dataType:'json',
                ...
                eventClick: function(event){
                    if (event.id > 2) {
                        ...
                        if (confirm('Вы действительно хотите удалить')) {
                            $.ajax({
                                url: "{{ route('calendarmuslim.destroy', '') }}" + '/' + id,
                                type: "DELETE",
                                dataType: 'json',
                                success: function (response) {
