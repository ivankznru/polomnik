...
@section('heading', 'Редактировать фото')

@section('right_top_button')
<a href="{{ route('admin_photo_view') }}" class="btn btn-primary"><i class="fa fa-eye"></i>Все фото</a>
@endsection
                    ...
                    <form action="{{ route('admin_photo_update',$photo_data->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Фото на замену</label>
                                    <div>
